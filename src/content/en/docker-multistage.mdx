...
As the data shown above, distroless + multistage got the smallest image size. Alpine ranked second, and Debian with multistage build processes ranked third. The last two is Debian with a single stage build process.
...
> [Check available images here on distroless GitHub readme](http://github.com/GoogleContainerTools/distroless?tab=readme-ov-file#what-images-are-available)
